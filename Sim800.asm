...
; end of _PwrUpGSM3
_WriteToFlashTemp:
;Sim800.c,122 :: 		void WriteToFlashTemp(){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Sim800.c,126 :: 		GetStrLengths();
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
JAL	_GetStrLengths+0
NOP	
;Sim800.c,128 :: 		memset(buff,0,512);                  //make every byte NULL
ORI	R27, R0, 512
MOVZ	R26, R0, R0
...
JAL	_memset+0
NOP	
;Sim800.c,129 :: 		memcpy(buff,SF.SimCelNum,SL.l1);          //Save Cell num
...
JAL	_memcpy+0
NOP	
;Sim800.c,130 :: 		memcpy(buff+SL.l1,SF.WriteAPIKey,SL.l2);//Save API Wr Key
...
JAL	_memcpy+0
NOP	
;Sim800.c,131 :: 		memcpy(buff+SL.l1l2,SF.ReadAPIKey,SL.l3); //Save API Rd Key
...
JAL	_memcpy+0
NOP	
;Sim800.c,132 :: 		memcpy(buff+SL.l1l2l3,SF.APN,SL.l4);        //Save APN
...
JAL	_memcpy+0
NOP	
;Sim800.c,133 :: 		memcpy(buff+SL.l1l2l3l4,SF.PWD,SL.l5);        //Save PWD
...
JAL	_memcpy+0
NOP	
;Sim800.c,135 :: 		memcpy(temp,buff,SL.lTotA+4);
...
JAL	_memcpy+0
NOP	
;Sim800.c,137 :: 		pos = FLASH_Settings_PAddr;
; pos start address is: 12 (R3)
LW	R3, Offset(_FLASH_Settings_PAddr+0)(GP)
;Sim800.c,138 :: 		j = NVMErasePage(pos);
SW	R3, 16(SP)
...
;Sim800.c,142 :: 		j = NVMWriteWord(pos,temp[i]);
LH	R2, Offset(WriteToFlashTemp_i_L0+0)(GP)
SLL	R3, R2, 2
...
_GetValuesFromFlash:
;Sim800.c,162 :: 		char* GetValuesFromFlash(){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Sim800.c,165 :: 		GetStrLengths();
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
JAL	_GetStrLengths+0
...
MOVZ	R4, R2, R0
;Sim800.c,169 :: 		for(i=0;i<SL.lTotA;i++){
...
LBU	R2, 0(R2)
SB	R2, 0(R3)
;Sim800.c,172 :: 		UART1_Write(buff[i]);
LUI	R2, hi_addr(_buff+0)
ORI	R2, R2, lo_addr(_buff+0)
ADDU	R2, R2, R5
LBU	R25, 0(R2)
...
;Sim800.c,176 :: 		strncpy(SF.SimCelNum,buff,SL.l1);
LH	R27, Offset(_SL+0)(GP)
LUI	R26, hi_addr(_buff+0)
ORI	R26, R26, lo_addr(_buff+0)
LUI	R25, hi_addr(_SF+18)
...
JAL	_strncpy+0
NOP	
;Sim800.c,177 :: 		strncpy(SF.WriteAPIKey,buff+SL.l1,SL.l2);
LH	R3, Offset(_SL+0)(GP)
LUI	R2, hi_addr(_buff+0)
ORI	R2, R2, lo_addr(_buff+0)
ADDU	R2, R2, R3
...
JAL	_strncpy+0
NOP	
;Sim800.c,178 :: 		strncpy(SF.ReadAPIKey,buff+SL.l1l2,SL.l3);
LH	R3, Offset(_SL+18)(GP)
LUI	R2, hi_addr(_buff+0)
ORI	R2, R2, lo_addr(_buff+0)
ADDU	R2, R2, R3
...
JAL	_strncpy+0
NOP	
;Sim800.c,179 :: 		strncpy(SF.APN,buff+SL.l1l2l3,SL.l4);
LH	R3, Offset(_SL+20)(GP)
LUI	R2, hi_addr(_buff+0)
ORI	R2, R2, lo_addr(_buff+0)
ADDU	R2, R2, R3
...
JAL	_strncpy+0
NOP	
;Sim800.c,180 :: 		strncpy(SF.PWD,buff+SL.l1l2l3l4,SL.l5);
LH	R3, Offset(_SL+22)(GP)
LUI	R2, hi_addr(_buff+0)
ORI	R2, R2, lo_addr(_buff+0)
ADDU	R2, R2, R3
...
JAL	_strncpy+0
NOP	
;Sim800.c,189 :: 		,SF.ReadAPIKey,SF.APN,SF.PWD);
...
SW	R2, 16(SP)
;Sim800.c,188 :: 		,SF.SimCelNum,SF.WriteAPIKey
...
SW	R2, 8(SP)
;Sim800.c,187 :: 		" * SF.PWD:         %s\r\n"
LUI	R2, hi_addr(?lstr_5_Sim800+0)
ORI	R2, R2, lo_addr(?lstr_5_Sim800+0)
SW	R2, 4(SP)
;Sim800.c,182 :: 		PrintOut(PrintHandler, " * Flash Read        \r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,189 :: 		,SF.ReadAPIKey,SF.APN,SF.PWD);
...
NOP	
ADDIU	SP, SP, 28
;Sim800.c,191 :: 		return SF.SimCelNum;
LUI	R2, hi_addr(_SF+18)
ORI	R2, R2, lo_addr(_SF+18)
;Sim800.c,192 :: 		}
;Sim800.c,191 :: 		return SF.SimCelNum;
...
_GetStrLengths:
;Sim800.c,197 :: 		void GetStrLengths(){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Sim800.c,199 :: 		SL.l1 = sizeof(SF.SimCelNum)-1;   //len of cell num
ORI	R2, R0, 19
SH	R2, Offset(_SL+0)(GP)
;Sim800.c,200 :: 		SL.l2 = sizeof(SF.WriteAPIKey)-1; //len of API Write key
ORI	R2, R0, 19
SH	R2, Offset(_SL+2)(GP)
;Sim800.c,201 :: 		SL.l3 = sizeof(SF.ReadAPIKey)-1;  //len of API Read Key
ORI	R2, R0, 19
SH	R2, Offset(_SL+4)(GP)
;Sim800.c,202 :: 		SL.l4 = sizeof(SF.APN)-1;         //len of APN
ORI	R2, R0, 19
SH	R2, Offset(_SL+6)(GP)
;Sim800.c,203 :: 		SL.l5 = sizeof(SF.PWD)-1;         //len of PWD
ORI	R2, R0, 19
SH	R2, Offset(_SL+8)(GP)
;Sim800.c,206 :: 		SL.lTotA     = SL.l1 + SL.l2 + SL.l3 + SL.l4 + SL.l5;
ORI	R2, R0, 95
SH	R2, Offset(_SL+14)(GP)
;Sim800.c,207 :: 		SL.l1l2      = SL.l1 + SL.l2;
ORI	R2, R0, 38
SH	R2, Offset(_SL+18)(GP)
;Sim800.c,208 :: 		SL.l1l2l3    = SL.l1l2 + SL.l3;
ORI	R2, R0, 57
SH	R2, Offset(_SL+20)(GP)
;Sim800.c,209 :: 		SL.l1l2l3l4  = SL.l1l2l3 + SL.l4;
ORI	R2, R0, 76
SH	R2, Offset(_SL+22)(GP)
;Sim800.c,211 :: 		SL.mod = SL.lTotA % 4;  //total divisable by 4 = flash Wrd size
ORI	R2, R0, 3
SH	R2, Offset(_SL+16)(GP)
;Sim800.c,212 :: 		SL.mod = 4 - SL.mod;
ORI	R2, R0, 1
SH	R2, Offset(_SL+16)(GP)
;Sim800.c,213 :: 		SL.lTotA += SL.mod;
ORI	R2, R0, 96
SH	R2, Offset(_SL+14)(GP)
;Sim800.c,216 :: 		sprintf(a,"%d",SL.l1);
ORI	R2, R0, 19
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,217 :: 		sprintf(b,"%d",SL.l2);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,218 :: 		sprintf(c,"%d",SL.l3);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,219 :: 		sprintf(d,"%d",SL.l4);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,220 :: 		sprintf(e,"%d",SL.l5);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,221 :: 		sprintf(f,"%d",SL.lTotA);
LH	R2, Offset(_SL+14)(GP)
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
_RcvSimTxt:
;Sim800.c,236 :: 		void RcvSimTxt(){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Sim800.c,238 :: 		while(UART2_Data_Ready()) {     // If data is received
L_RcvSimTxt17:
...
NOP	
L__RcvSimTxt249:
;Sim800.c,239 :: 		if (U2STAbits.FERR || U2STAbits.OERR){
...
L__RcvSimTxt215:
L__RcvSimTxt214:
;Sim800.c,240 :: 		if (U2STAbits.FERR ){
LBU	R2, Offset(U2STAbits+0)(GP)
EXT	R2, R2, 2, 1
...
NOP	
L__RcvSimTxt253:
;Sim800.c,241 :: 		U2STAbits.FERR = 0;
ORI	R2, R0, 4
SW	R2, Offset(U2STAbits+4)(GP)
;Sim800.c,242 :: 		goto m0;
J	___RcvSimTxt_m0
NOP	
;Sim800.c,243 :: 		}
L_RcvSimTxt22:
;Sim800.c,244 :: 		if(U2STAbits.OERR)
LBU	R2, Offset(U2STAbits+0)(GP)
EXT	R2, R2, 1, 1
...
NOP	
L__RcvSimTxt256:
;Sim800.c,251 :: 		RB.buff[RB.head] = txt;
...
;Sim800.c,252 :: 		RB.head++;
LHU	R2, Offset(_RB+1002)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(_RB+1002)(GP)
;Sim800.c,253 :: 		}else if(U2RXREG == 0x0A){
J	L_RcvSimTxt25
NOP	
L_RcvSimTxt24:
...
NOP	
L__RcvSimTxt258:
;Sim800.c,258 :: 		RB.head = 0;             //rest head when buffer is full
SH	R0, Offset(_RB+1002)(GP)
;Sim800.c,259 :: 		}
L_RcvSimTxt27:
;Sim800.c,260 :: 		}
...
; end of _RcvSimTxt
_TestRingPointers:
;Sim800.c,267 :: 		int TestRingPointers(){
;Sim800.c,269 :: 		if(RB.tail > RB.head){
LHU	R3, Offset(_RB+1002)(GP)
...
;Sim800.c,270 :: 		diff = 1000 - RB.tail;
LHU	R3, Offset(_RB+1004)(GP)
ORI	R2, R0, 1000
SUBU	R3, R2, R3
;Sim800.c,271 :: 		diff += RB.head;
LHU	R2, Offset(_RB+1002)(GP)
ADDU	R2, R3, R2
...
;Sim800.c,273 :: 		diff = RB.head - RB.tail;
LHU	R3, Offset(_RB+1004)(GP)
LHU	R2, Offset(_RB+1002)(GP)
SUBU	R2, R2, R3
...
_WaitForResponse:
;Sim800.c,281 :: 		void WaitForResponse(short dly){
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;Sim800.c,283 :: 		lastMillis = TMR0.millis;
; lastMillis start address is: 20 (R5)
LW	R5, Offset(_TMR0+0)(GP)
;Sim800.c,284 :: 		RB.rcv_txt_fin   = 0;
SB	R0, Offset(_RB+0)(GP)
;Sim800.c,285 :: 		RB.last_head     = RB.head;
LHU	R2, Offset(_RB+1002)(GP)
...
;Sim800.c,305 :: 		}while(!RB.rcv_txt_fin);
;Sim800.c,286 :: 		do{
L_WaitForResponse30:
;Sim800.c,287 :: 		LATE3_bit = !LATE3_bit;
; lastMillis start address is: 20 (R5)
...
;Sim800.c,293 :: 		UART2_Write_Text("ATE0");
ORI	R30, R0, 65
SB	R30, 5(SP)
ORI	R30, R0, 84
SB	R30, 6(SP)
...
NOP	
;Sim800.c,294 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,295 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
LB	R25, 4(SP)
;Sim800.c,296 :: 		Delay_ms(2000);
LUI	R24, 813
ORI	R24, R24, 52564
L_WaitForResponse42:
ADDIU	R24, R24, -1
...
L_WaitForResponse40:
L_WaitForResponse36:
;Sim800.c,302 :: 		newMillis = TMR0.millis - lastMillis;
LW	R2, Offset(_TMR0+0)(GP)
SUBU	R3, R2, R5
;Sim800.c,303 :: 		if(newMillis > 59000)
ORI	R2, R0, 59000
SLTU	R2, R2, R3
...
_RingToTempBuf:
;Sim800.c,311 :: 		void RingToTempBuf(){
;Sim800.c,313 :: 		i=0;
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
...
NOP	
L__RingToTempBuf270:
;Sim800.c,317 :: 		SimTestTxt[i] = RB.buff[RB.tail];
SEH	R3, R5
...
ADDIU	R2, R5, 1
SEH	R5, R2
;Sim800.c,323 :: 		RB.tail++;
LHU	R2, Offset(_RB+1004)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(_RB+1004)(GP)
;Sim800.c,324 :: 		if(RB.tail > 999)
ANDI	R2, R2, 65535
SLTIU	R2, R2, 1000
...
ADDU	R2, R2, R3
SB	R0, 0(R2)
;Sim800.c,329 :: 		RB.last_tail = RB.tail;
LHU	R2, Offset(_RB+1004)(GP)
...
NOP	
ADDIU	SP, SP, 8
;Sim800.c,349 :: 		WaitForResponse(3);
ORI	R25, R0, 3
JAL	_WaitForResponse+0
NOP	
;Sim800.c,350 :: 		Delay_ms(4000);
LUI	R24, 1627
ORI	R24, R24, 39594
L_SetupIOT51:
ADDIU	R24, R24, -1
...
NOP	
;Sim800.c,351 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,357 :: 		,SimTestTxt);
LUI	R2, hi_addr(_SimTestTxt+0)
ORI	R2, R2, lo_addr(_SimTestTxt+0)
ADDIU	SP, SP, -12
SW	R2, 8(SP)
;Sim800.c,356 :: 		" * Check if Sim is Registered\r\n"
...
;Sim800.c,359 :: 		wait:
___SetupIOT_wait:
;Sim800.c,361 :: 		UART2_Write_Text("AT+CREG?");
ADDIU	R23, SP, 12
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,362 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,363 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,364 :: 		WaitForResponse(1);
ORI	R25, R0, 1
JAL	_WaitForResponse+0
NOP	
;Sim800.c,365 :: 		Delay_ms(5000);
LUI	R24, 2034
ORI	R24, R24, 33108
L_SetupIOT53:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,366 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,371 :: 		,SimTestTxt);
LUI	R2, hi_addr(_SimTestTxt+0)
ORI	R2, R2, lo_addr(_SimTestTxt+0)
ADDIU	SP, SP, -12
SW	R2, 8(SP)
...
SW	R2, 4(SP)
;Sim800.c,369 :: 		PrintOut(PrintHandler, "\r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,371 :: 		,SimTestTxt);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,375 :: 		if(RB.head > RB.last_head){
...
NOP	
L__SetupIOT273:
;Sim800.c,377 :: 		num_strs = strsplit(SimTestTxt,',');
ORI	R26, R0, 44
LUI	R25, hi_addr(_SimTestTxt+0)
ORI	R25, R25, lo_addr(_SimTestTxt+0)
JAL	_strsplit+0
NOP	
;Sim800.c,380 :: 		sprintf(txtA,"%d",num_strs);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,390 :: 		,string[3],string[4]);
...
SW	R2, 24(SP)
;Sim800.c,389 :: 		,string[1],string[2]
...
NOP	
ADDIU	SP, SP, 32
;Sim800.c,392 :: 		str_rcv = findnumber(string[1]);
LUI	R25, hi_addr(_string+64)
ORI	R25, R25, lo_addr(_string+64)
JAL	_findnumber+0
NOP	
;Sim800.c,393 :: 		res = atoi(str_rcv);  //get the sms rec number
MOVZ	R25, R2, R0
JAL	_atoi+0
NOP	
; res start address is: 16 (R4)
SEH	R4, R2
;Sim800.c,394 :: 		if(res == 1){
SEH	R3, R2
ORI	R2, R0, 1
...
NOP	
L__SetupIOT274:
;Sim800.c,396 :: 		sprintf(txtA,"%d",res);
ADDIU	SP, SP, -12
SH	R4, 8(SP)
...
ADDIU	SP, SP, -12
SW	R2, 8(SP)
;Sim800.c,398 :: 		" *Registered with:= %s\r\n"
...
NOP	
L_SetupIOT56:
;Sim800.c,405 :: 		" *Sim Not Registered\r\n");
...
; end of _SetupIOT
_WaitForSetupSMS:
;Sim800.c,425 :: 		char WaitForSetupSMS(unsigned int Indx){
ADDIU	SP, SP, -40
SW	RA, 0(SP)
;Sim800.c,429 :: 		UART2_Write_Text("AT+CMGF=1");
SW	R26, 4(SP)
SW	R27, 8(SP)
ADDIU	R23, SP, 16
ADDIU	R22, R23, 10
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,430 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,431 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,434 :: 		WaitForResponse(0);
MOVZ	R25, R0, R0
JAL	_WaitForResponse+0
NOP	
LHU	R25, 12(SP)
...
NOP	
;Sim800.c,439 :: 		WaitForResponse(0);
SH	R25, 12(SP)
MOVZ	R25, R0, R0
JAL	_WaitForResponse+0
NOP	
LHU	R25, 12(SP)
;Sim800.c,440 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_WaitForSetupSMS62:
ADDIU	R24, R24, -1
...
NOP	
;Sim800.c,441 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,443 :: 		num_strs = strsplit(SimTestTxt,',');
SH	R25, 12(SP)
ORI	R26, R0, 44
LUI	R25, hi_addr(_SimTestTxt+0)
ORI	R25, R25, lo_addr(_SimTestTxt+0)
...
SEH	R21, R2
;Sim800.c,446 :: 		sprintf(txtA,"%d",num_strs);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,447 :: 		sprintf(txtA,"%d",num_strs);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,458 :: 		string[4],string[5]);
...
ORI	R2, R2, lo_addr(_string+256)
SW	R2, 28(SP)
;Sim800.c,457 :: 		string[2],string[3],
LUI	R2, hi_addr(_string+192)
ORI	R2, R2, lo_addr(_string+192)
SW	R2, 24(SP)
LUI	R2, hi_addr(_string+128)
ORI	R2, R2, lo_addr(_string+128)
SW	R2, 20(SP)
;Sim800.c,456 :: 		,txtA,string[0],string[1],
LUI	R2, hi_addr(_string+64)
ORI	R2, R2, lo_addr(_string+64)
SW	R2, 16(SP)
LUI	R2, hi_addr(_string+0)
...
NOP	
ADDIU	SP, SP, 36
;Sim800.c,461 :: 		res = atoi(string[1]);
LUI	R25, hi_addr(_string+64)
ORI	R25, R25, lo_addr(_string+64)
JAL	_atoi+0
NOP	
SH	R2, 14(SP)
;Sim800.c,462 :: 		sprintf(sms,"%d",res);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,470 :: 		UART2_Write_Text("AT+CMGR=");
ADDIU	R23, SP, 26
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,471 :: 		UART2_Write_Text(sms);
LUI	R25, hi_addr(_sms+0)
ORI	R25, R25, lo_addr(_sms+0)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,472 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,473 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,475 :: 		WaitForResponse(1);
ORI	R25, R0, 1
JAL	_WaitForResponse+0
NOP	
LHU	R25, 12(SP)
;Sim800.c,476 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_WaitForSetupSMS64:
ADDIU	R24, R24, -1
...
NOP	
;Sim800.c,477 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,478 :: 		num_strs = strsplit(SimTestTxt,',');
SH	R25, 12(SP)
ORI	R26, R0, 44
LUI	R25, hi_addr(_SimTestTxt+0)
ORI	R25, R25, lo_addr(_SimTestTxt+0)
JAL	_strsplit+0
NOP	
;Sim800.c,480 :: 		sprintf(txtA,"%d",num_strs);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
SW	R2, 36(SP)
;Sim800.c,494 :: 		,string[4],string[5]
LUI	R2, hi_addr(_string+320)
ORI	R2, R2, lo_addr(_string+320)
SW	R2, 32(SP)
LUI	R2, hi_addr(_string+256)
ORI	R2, R2, lo_addr(_string+256)
SW	R2, 28(SP)
;Sim800.c,493 :: 		,string[2],string[3]
LUI	R2, hi_addr(_string+192)
ORI	R2, R2, lo_addr(_string+192)
SW	R2, 24(SP)
LUI	R2, hi_addr(_string+128)
ORI	R2, R2, lo_addr(_string+128)
SW	R2, 20(SP)
;Sim800.c,492 :: 		,txtA,string[0],string[1]
LUI	R2, hi_addr(_string+64)
ORI	R2, R2, lo_addr(_string+64)
SW	R2, 16(SP)
LUI	R2, hi_addr(_string+0)
...
;Sim800.c,501 :: 		strncpy(SF.SimCelNum,string[1],strlen(string[1])+11);
SH	R25, 12(SP)
LUI	R25, hi_addr(_string+64)
ORI	R25, R25, lo_addr(_string+64)
JAL	_strlen+0
...
JAL	_strncpy+0
NOP	
;Sim800.c,502 :: 		strncpy(SF.SimDate,string[3],strlen(string[3])+1);
...
JAL	_strncpy+0
NOP	
;Sim800.c,503 :: 		strncpy(SF.SimTime,string[4],8);
ORI	R27, R0, 8
...
JAL	_strncpy+0
NOP	
;Sim800.c,510 :: 		,SF.SimCelNum,SF.SimDate,SF.SimTime);
...
JAL	_strncpy+0
NOP	
;Sim800.c,517 :: 		strncpy(SF.ReadAPIKey,string[6],strlen(string[6])+1);
...
JAL	_strncpy+0
NOP	
;Sim800.c,520 :: 		strncpy(SF.APN,string[7],strlen(string[7])+1);
...
JAL	_strncpy+0
NOP	
;Sim800.c,523 :: 		strncpy(SF.PWD,string[8],strlen(string[8])+1);
...
ORI	R2, R2, lo_addr(_SF+98)
SW	R2, 16(SP)
;Sim800.c,531 :: 		,SF.WriteAPIKey,SF.ReadAPIKey
LUI	R2, hi_addr(_SF+78)
ORI	R2, R2, lo_addr(_SF+78)
SW	R2, 12(SP)
LUI	R2, hi_addr(_SF+58)
...
NOP	
NOP	
;Sim800.c,539 :: 		RemoveSMSText(res);
SH	R25, 12(SP)
LH	R25, 14(SP)
JAL	_RemoveSMSText+0
NOP	
;Sim800.c,540 :: 		res = strcmp(SimTestTxt,"OK,");
ORI	R30, R0, 79
SB	R30, 35(SP)
ORI	R30, R0, 75
SB	R30, 36(SP)
...
NOP	
SH	R2, 14(SP)
;Sim800.c,542 :: 		sprintf(txtA,"%d",res);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
SW	R2, 4(SP)
;Sim800.c,543 :: 		PrintOut(PrintHandler, "\r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,546 :: 		,SimTestTxt,txtA);
...
;Sim800.c,550 :: 		WriteToFlashTemp();
JAL	_WriteToFlashTemp+0
NOP	
;Sim800.c,551 :: 		return 3;
ORI	R2, R0, 3
...
;Sim800.c,553 :: 		else if ((res == 0)&&(Indx == 0))
LH	R2, 14(SP)
...
_AT_Initial:
;Sim800.c,563 :: 		void AT_Initial(){
ADDIU	SP, SP, -28
SW	RA, 0(SP)
;Sim800.c,566 :: 		UART2_Write_Text("AT&W+CNMI=2,1,0,0,0");
SW	R25, 4(SP)
ADDIU	R23, SP, 8
ADDIU	R22, R23, 20
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,567 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,568 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,571 :: 		WaitForResponse(0);
MOVZ	R25, R0, R0
JAL	_WaitForResponse+0
NOP	
;Sim800.c,572 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_AT_Initial79:
ADDIU	R24, R24, -1
...
; end of _AT_Initial
_GetAPI_Key_SMS:
;Sim800.c,579 :: 		char GetAPI_Key_SMS(){
ADDIU	SP, SP, -80
SW	RA, 0(SP)
;Sim800.c,584 :: 		UART2_Write_Text("AT+CMGS=");
SW	R25, 4(SP)
ADDIU	R23, SP, 8
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,585 :: 		UART2_Write_Text(SF.SimCelNum);
LUI	R25, hi_addr(_SF+18)
ORI	R25, R25, lo_addr(_SF+18)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,586 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,587 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,590 :: 		WaitForResponse(0);
MOVZ	R25, R0, R0
JAL	_WaitForResponse+0
NOP	
;Sim800.c,591 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,592 :: 		Delay_ms(500);
LUI	R24, 203
ORI	R24, R24, 29524
L_GetAPI_Key_SMS81:
ADDIU	R24, R24, -1
...
SW	R2, 4(SP)
;Sim800.c,594 :: 		PrintOut(PrintHandler, "\r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,596 :: 		,SimTestTxt);
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,599 :: 		UART2_Write_Text("Reply with the API Write Key from ThingSpeak starting with a ,");
ADDIU	R23, SP, 17
ADDIU	R22, R23, 63
...
JAL	_UART2_Write+0
NOP	
;Sim800.c,602 :: 		UART2_Write(0x1A);
ORI	R25, R0, 26
JAL	_UART2_Write+0
NOP	
;Sim800.c,604 :: 		response = WaitForSetupSMS(1);
ORI	R25, R0, 1
JAL	_WaitForSetupSMS+0
NOP	
;Sim800.c,606 :: 		return response;
;Sim800.c,607 :: 		}
;Sim800.c,606 :: 		return response;
;Sim800.c,607 :: 		}
...
_SendSMS:
;Sim800.c,612 :: 		char SendSMS(char sms_type,char cellNum){
ADDIU	SP, SP, -528
SW	RA, 0(SP)
;Sim800.c,618 :: 		str = (char*)Malloc(100*sizeof(char*));
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
SB	R25, 16(SP)
...
MOVZ	R6, R2, R0
;Sim800.c,619 :: 		if(!cellNum)
BEQ	R26, R0, L__SendSMS285
NOP	
J	L_SendSMS83
NOP	
L__SendSMS285:
;Sim800.c,620 :: 		strcpy(tempCellNum,string[1]);
ADDIU	R2, SP, 81
SB	R25, 16(SP)
LUI	R26, hi_addr(_string+64)
ORI	R26, R26, lo_addr(_string+64)
...
NOP	
L_SendSMS83:
;Sim800.c,622 :: 		strcpy(tempCellNum,SF.SimCelNum);
ADDIU	R2, SP, 81
SB	R25, 16(SP)
LUI	R26, hi_addr(_SF+18)
ORI	R26, R26, lo_addr(_SF+18)
...
NOP	
L__SendSMS286:
;Sim800.c,625 :: 		onecA = 1;
ORI	R2, R0, 1
SB	R2, Offset(SendSMS_onecA_L0+0)(GP)
;Sim800.c,626 :: 		AT_Initial();
JAL	_AT_Initial+0
NOP	
;Sim800.c,627 :: 		}
L_SendSMS85:
...
NOP	
;Sim800.c,633 :: 		UART2_Write_Text("AT+CMGS=");
ADDIU	R23, SP, 111
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,634 :: 		UART2_Write_Text(tempCellNum);//SF.SimCelNum);
ADDIU	R2, SP, 81
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,635 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,636 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
LBU	R25, 16(SP)
;Sim800.c,637 :: 		Delay_ms(2000);
LUI	R24, 813
ORI	R24, R24, 52564
L_SendSMS88:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,638 :: 		switch(sms_type){
J	L_SendSMS90
NOP	
;Sim800.c,639 :: 		case 0:
L_SendSMS92:
;Sim800.c,640 :: 		UART2_Write_Text("ERROR in setup Power down and start again!");
ADDIU	R23, SP, 120
ADDIU	R22, R23, 43
...
;Sim800.c,642 :: 		case 1:
L_SendSMS93:
;Sim800.c,643 :: 		UART2_Write_Text("Reply WebSite");
ADDIU	R23, SP, 163
ADDIU	R22, R23, 14
...
;Sim800.c,645 :: 		case 2:
L_SendSMS94:
;Sim800.c,646 :: 		UART2_Write_Text("Reply API Key");
ADDIU	R23, SP, 177
ADDIU	R22, R23, 14
...
;Sim800.c,648 :: 		case 3:
L_SendSMS95:
;Sim800.c,649 :: 		UART2_Write_Text("Setup Complete!");
ADDIU	R23, SP, 191
ADDIU	R22, R23, 16
...
;Sim800.c,651 :: 		case 4:
L_SendSMS96:
;Sim800.c,652 :: 		UART2_Write_Text("Device Powered up!");
ADDIU	R23, SP, 207
ADDIU	R22, R23, 19
...
;Sim800.c,654 :: 		case 5:
L_SendSMS97:
;Sim800.c,655 :: 		UART2_Write_Text("SMS Not recieved!");
ADDIU	R23, SP, 226
ADDIU	R22, R23, 18
...
J	L_SendSMS91
NOP	
;Sim800.c,657 :: 		case 6: //read the set points
L_SendSMS98:
;Sim800.c,658 :: 		str = Read_Thresholds();
JAL	_Read_Thresholds+0
NOP	
; str start address is: 24 (R6)
MOVZ	R6, R2, R0
;Sim800.c,659 :: 		strncpy(b,str,strlen(str)-4);
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
ADDIU	R3, R2, -4
...
JAL	_strncpy+0
NOP	
;Sim800.c,660 :: 		UART2_Write_Text(b);
ADDIU	R2, SP, 17
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
...
J	L_SendSMS91
NOP	
;Sim800.c,662 :: 		case 7: //read raw values
L_SendSMS99:
;Sim800.c,663 :: 		str = Read_Send_AllColour(0);
MOVZ	R25, R0, R0
JAL	_Read_Send_AllColour+0
NOP	
; str start address is: 24 (R6)
MOVZ	R6, R2, R0
;Sim800.c,664 :: 		strncpy(b,str,strlen(str));
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
ADDIU	R3, SP, 17
...
JAL	_strncpy+0
NOP	
;Sim800.c,665 :: 		UART2_Write_Text(b);
ADDIU	R2, SP, 17
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
...
J	L_SendSMS91
NOP	
;Sim800.c,667 :: 		case 8: //read scaled values
L_SendSMS100:
;Sim800.c,668 :: 		str = Read_Send_AllColour(1);
ORI	R25, R0, 1
JAL	_Read_Send_AllColour+0
NOP	
; str start address is: 24 (R6)
MOVZ	R6, R2, R0
;Sim800.c,669 :: 		strncpy(b,str,strlen(str));
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
ADDIU	R3, SP, 17
...
JAL	_strncpy+0
NOP	
;Sim800.c,670 :: 		UART2_Write_Text(b);
ADDIU	R2, SP, 17
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
...
;Sim800.c,672 :: 		case 9:
L_SendSMS101:
;Sim800.c,673 :: 		UART2_Write_Text("Test Started!");
ADDIU	R23, SP, 244
ADDIU	R22, R23, 14
...
J	L_SendSMS91
NOP	
;Sim800.c,675 :: 		case 10:
L_SendSMS102:
;Sim800.c,676 :: 		UART2_Write_Text("Test Stopped!");
ADDIU	R23, SP, 258
ADDIU	R22, R23, 14
...
J	L_SendSMS91
NOP	
;Sim800.c,678 :: 		case 11:
L_SendSMS103:
;Sim800.c,679 :: 		UART2_Write_Text("You are not permitted to set the threshold contact the supplier!");
ADDIU	R23, SP, 272
ADDIU	R22, R23, 65
...
J	L_SendSMS91
NOP	
;Sim800.c,681 :: 		case 12:
L_SendSMS104:
;Sim800.c,682 :: 		UART2_Write_Text("Not a recognised command!");
ADDIU	R23, SP, 337
ADDIU	R22, R23, 26
...
J	L_SendSMS91
NOP	
;Sim800.c,684 :: 		case 13:
L_SendSMS105:
;Sim800.c,685 :: 		UART2_Write_Text("You cannot stop this test contact the owner of this test!");
ADDIU	R23, SP, 363
ADDIU	R22, R23, 58
...
J	L_SendSMS91
NOP	
;Sim800.c,687 :: 		case 14:
L_SendSMS106:
;Sim800.c,688 :: 		UART2_Write_Text("Test already started contact owner of this test!");
ADDIU	R23, SP, 421
ADDIU	R22, R23, 49
...
J	L_SendSMS91
NOP	
;Sim800.c,690 :: 		case 15:
L_SendSMS107:
;Sim800.c,691 :: 		UART2_Write_Text("Test has not been started!");
ADDIU	R23, SP, 470
ADDIU	R22, R23, 27
...
J	L_SendSMS91
NOP	
;Sim800.c,693 :: 		case 16: //read scaled values
L_SendSMS108:
;Sim800.c,694 :: 		str = ReadHUE();
JAL	_ReadHUE+0
NOP	
; str start address is: 24 (R6)
MOVZ	R6, R2, R0
;Sim800.c,695 :: 		strncpy(b,str,strlen(str));
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
ADDIU	R3, SP, 17
...
JAL	_strncpy+0
NOP	
;Sim800.c,696 :: 		UART2_Write_Text(b);
ADDIU	R2, SP, 17
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
...
J	L_SendSMS91
NOP	
;Sim800.c,698 :: 		default:
L_SendSMS109:
;Sim800.c,699 :: 		UART2_Write_Text("Error Power cycle the device!");
ADDIU	R23, SP, 497
ADDIU	R22, R23, 30
...
; str end address is: 24 (R6)
L_SendSMS91:
;Sim800.c,702 :: 		UART2_Write(0x0D);
; str start address is: 12 (R3)
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,703 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,704 :: 		UART2_Write(0x1A);
ORI	R25, R0, 26
JAL	_UART2_Write+0
NOP	
;Sim800.c,705 :: 		Delay_ms(5000);
LUI	R24, 2034
ORI	R24, R24, 33108
L_SendSMS110:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,707 :: 		Free(str,100*sizeof(char*));
ORI	R26, R0, 400
MOVZ	R25, R3, R0
...
; end of _SendSMS
_GetSMSText:
;Sim800.c,714 :: 		char* GetSMSText(){
ADDIU	SP, SP, -40
SW	RA, 0(SP)
;Sim800.c,717 :: 		UART1_Write_Text("=================\r\n");
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
ADDIU	R23, SP, 20
...
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,722 :: 		num_strs = strsplit(SimTestTxt,',');
ORI	R26, R0, 44
LUI	R25, hi_addr(_SimTestTxt+0)
ORI	R25, R25, lo_addr(_SimTestTxt+0)
JAL	_strsplit+0
...
SEH	R5, R2
;Sim800.c,724 :: 		err = strncmp(sms_test,string[0],4);
ORI	R27, R0, 4
...
NOP	
SH	R2, 18(SP)
;Sim800.c,726 :: 		sprintf(txtA,"%d",num_strs);
ADDIU	SP, SP, -12
SH	R5, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,727 :: 		sprintf(txtB,"%d",err);
LH	R2, 18(SP)
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,744 :: 		,string[7],string[8]);
LUI	R2, hi_addr(_string+512)
ORI	R2, R2, lo_addr(_string+512)
ADDIU	SP, SP, -52
SW	R2, 48(SP)
...
ORI	R2, R2, lo_addr(_string+448)
SW	R2, 44(SP)
;Sim800.c,743 :: 		,string[5],string[6]
LUI	R2, hi_addr(_string+384)
ORI	R2, R2, lo_addr(_string+384)
SW	R2, 40(SP)
LUI	R2, hi_addr(_string+320)
ORI	R2, R2, lo_addr(_string+320)
SW	R2, 36(SP)
;Sim800.c,742 :: 		,string[3],string[4]
LUI	R2, hi_addr(_string+256)
ORI	R2, R2, lo_addr(_string+256)
SW	R2, 32(SP)
LUI	R2, hi_addr(_string+192)
ORI	R2, R2, lo_addr(_string+192)
SW	R2, 28(SP)
;Sim800.c,741 :: 		,string[1],string[2]
LUI	R2, hi_addr(_string+128)
ORI	R2, R2, lo_addr(_string+128)
SW	R2, 24(SP)
LUI	R2, hi_addr(_string+64)
ORI	R2, R2, lo_addr(_string+64)
SW	R2, 20(SP)
;Sim800.c,740 :: 		,txtA,txtB,string[0]
LUI	R2, hi_addr(_string+0)
ORI	R2, R2, lo_addr(_string+0)
SW	R2, 16(SP)
LUI	R2, hi_addr(_txtB+0)
...
NOP	
L__GetSMSText322:
;Sim800.c,749 :: 		is_digit = isdigit(*string[1]);
LBU	R25, Offset(_string+64)(GP)
JAL	_isdigit+0
NOP	
;Sim800.c,751 :: 		if(is_digit == 1){
ANDI	R3, R2, 65535
ORI	R2, R0, 1
...
NOP	
L__GetSMSText323:
;Sim800.c,752 :: 		res = atoi(string[1]);
LUI	R25, hi_addr(_string+64)
ORI	R25, R25, lo_addr(_string+64)
JAL	_atoi+0
NOP	
SH	R2, 16(SP)
;Sim800.c,754 :: 		sprintf(sms,"%d",res);
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
;Sim800.c,763 :: 		}
L_GetSMSText114:
;Sim800.c,764 :: 		return RemoveSMSText(res);
LH	R25, 16(SP)
JAL	_RemoveSMSText+0
NOP	
SEH	R2, R2
...
; end of _GetSMSText
_ReadMSG:
;Sim800.c,774 :: 		char* ReadMSG(int msg_num){
ADDIU	SP, SP, -52
SW	RA, 0(SP)
;Sim800.c,777 :: 		sprintf(sms,"%d",msg_num);
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
ADDIU	SP, SP, -12
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,785 :: 		UART2_Write_Text("AT+CMGF=1");
ADDIU	R23, SP, 22
ADDIU	R22, R23, 10
...
NOP	
;Sim800.c,793 :: 		UART2_Write_Text("AT+CMGR=");
ADDIU	R23, SP, 32
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,794 :: 		UART2_Write_Text(sms);
LUI	R25, hi_addr(_sms+0)
ORI	R25, R25, lo_addr(_sms+0)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,795 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,796 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,798 :: 		WaitForResponse(1);
ORI	R25, R0, 1
JAL	_WaitForResponse+0
NOP	
;Sim800.c,799 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,800 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_ReadMSG119:
ADDIU	R24, R24, -1
...
ADDIU	SP, SP, -8
SW	R2, 4(SP)
;Sim800.c,803 :: 		PrintOut(PrintHandler, "\r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,804 :: 		"************** \r\n");
...
NOP	
ADDIU	SP, SP, 8
;Sim800.c,807 :: 		for(i = 0;i<strlen(SimTestTxt);i++){
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
; i end address is: 20 (R5)
L_ReadMSG121:
...
NOP	
L__ReadMSG325:
;Sim800.c,808 :: 		SimTestTxt[i] =  toupper(SimTestTxt[i]);
SEH	R3, R5
LUI	R2, hi_addr(_SimTestTxt+0)
ORI	R2, R2, lo_addr(_SimTestTxt+0)
ADDU	R2, R2, R3
...
NOP	
L_ReadMSG122:
;Sim800.c,811 :: 		num_strs = strsplit(SimTestTxt,',');
SH	R25, 16(SP)
ORI	R26, R0, 44
LUI	R25, hi_addr(_SimTestTxt+0)
ORI	R25, R25, lo_addr(_SimTestTxt+0)
...
NOP	
SH	R2, 18(SP)
;Sim800.c,812 :: 		text = strchr(string[4], '"');
ORI	R26, R0, 34
LUI	R25, hi_addr(_string+256)
ORI	R25, R25, lo_addr(_string+256)
JAL	_strchr+0
NOP	
;Sim800.c,813 :: 		strcpy(string[6], RemoveChars(text,'"','O'));
ORI	R27, R0, 79
ORI	R26, R0, 34
MOVZ	R25, R2, R0
JAL	_RemoveChars+0
...
JAL	_strcpy+0
NOP	
;Sim800.c,814 :: 		strcpy(string[3], RemoveChars(string[3],'"',0x0A));
ORI	R27, R0, 10
ORI	R26, R0, 34
LUI	R25, hi_addr(_string+192)
ORI	R25, R25, lo_addr(_string+192)
...
JAL	_strcpy+0
NOP	
;Sim800.c,815 :: 		memset(string[4]+8,0,1);
ORI	R27, R0, 1
MOVZ	R26, R0, R0
...
JAL	_memset+0
NOP	
;Sim800.c,816 :: 		strncpy(string[4],string[4],8);
ORI	R27, R0, 8
LUI	R26, hi_addr(_string+256)
ORI	R26, R26, lo_addr(_string+256)
LUI	R25, hi_addr(_string+256)
...
JAL	_strncpy+0
NOP	
;Sim800.c,820 :: 		sprintf(sms,"%d",num_strs);
LH	R2, 18(SP)
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,833 :: 		,string[6]);
LUI	R2, hi_addr(_string+384)
ORI	R2, R2, lo_addr(_string+384)
ADDIU	SP, SP, -40
SW	R2, 36(SP)
;Sim800.c,832 :: 		,string[4],string[5]
LUI	R2, hi_addr(_string+320)
ORI	R2, R2, lo_addr(_string+320)
SW	R2, 32(SP)
LUI	R2, hi_addr(_string+256)
ORI	R2, R2, lo_addr(_string+256)
SW	R2, 28(SP)
;Sim800.c,831 :: 		,string[2],string[3]
LUI	R2, hi_addr(_string+192)
ORI	R2, R2, lo_addr(_string+192)
SW	R2, 24(SP)
LUI	R2, hi_addr(_string+128)
ORI	R2, R2, lo_addr(_string+128)
SW	R2, 20(SP)
;Sim800.c,830 :: 		,sms,string[0],string[1]
LUI	R2, hi_addr(_string+64)
ORI	R2, R2, lo_addr(_string+64)
SW	R2, 16(SP)
LUI	R2, hi_addr(_string+0)
...
NOP	
L__ReadMSG327:
;Sim800.c,836 :: 		strcpy(string[6],RemoveWhiteSpace(string[6]));
SH	R25, 16(SP)
LUI	R25, hi_addr(_string+384)
ORI	R25, R25, lo_addr(_string+384)
...
JAL	_strcpy+0
NOP	
;Sim800.c,837 :: 		res = StrChecker(string[6]);
LUI	R25, hi_addr(_string+384)
ORI	R25, R25, lo_addr(_string+384)
JAL	_StrChecker+0
NOP	
LH	R25, 16(SP)
SH	R2, 20(SP)
;Sim800.c,840 :: 		if(res == 16){   //write_raw
SEH	R3, R2
ORI	R2, R0, 16
...
NOP	
L__ReadMSG328:
;Sim800.c,841 :: 		if((res == 16) && (strncmp(string[1],SF.SimCelNum,15))){
LH	R3, 20(SP)
ORI	R2, R0, 16
...
L__ReadMSG229:
L__ReadMSG228:
;Sim800.c,845 :: 		}else if(res == 17){ //start
J	L_ReadMSG129
NOP	
L_ReadMSG125:
LH	R3, 20(SP)
...
NOP	
L__ReadMSG332:
;Sim800.c,846 :: 		if(res == 17 && !SimVars.start){
LH	R3, 20(SP)
ORI	R2, R0, 17
...
L__ReadMSG334:
L__ReadMSG226:
;Sim800.c,847 :: 		strncpy(SF.StartCell,string[1],15);
SH	R25, 16(SP)
ORI	R27, R0, 15
LUI	R26, hi_addr(_string+64)
ORI	R26, R26, lo_addr(_string+64)
...
NOP	
LH	R25, 16(SP)
;Sim800.c,848 :: 		SimVars.start = 1;
LBU	R2, Offset(_SimVars+2)(GP)
ORI	R2, R2, 1
SB	R2, Offset(_SimVars+2)(GP)
;Sim800.c,849 :: 		}else if(res == 17 && SimVars.start){
J	L_ReadMSG134
NOP	
;Sim800.c,846 :: 		if(res == 17 && !SimVars.start){
L__ReadMSG231:
...
L__ReadMSG233:
L__ReadMSG232:
;Sim800.c,853 :: 		goto next;
J	___ReadMSG_next
NOP	
L_ReadMSG134:
;Sim800.c,854 :: 		}else if(res == 18){ //cancel
J	L_ReadMSG139
NOP	
L_ReadMSG130:
LH	R3, 20(SP)
...
NOP	
L__ReadMSG338:
;Sim800.c,857 :: 		!strncmp(string[1],SF.SimCelNum,15))){
LBU	R2, Offset(_SimVars+2)(GP)
EXT	R2, R2, 0, 1
...
NOP	
L__ReadMSG340:
;Sim800.c,856 :: 		(!strncmp(string[1],SF.StartCell,15)||
SH	R25, 16(SP)
ORI	R27, R0, 15
...
L__ReadMSG234:
L__ReadMSG223:
;Sim800.c,858 :: 		SimVars.start = 0;
LBU	R2, Offset(_SimVars+2)(GP)
INS	R2, R0, 0, 1
SB	R2, Offset(_SimVars+2)(GP)
;Sim800.c,864 :: 		,SF.StartCell,string[1]);
LUI	R2, hi_addr(_string+64)
ORI	R2, R2, lo_addr(_string+64)
SH	R25, 16(SP)
ADDIU	SP, SP, -16
...
ADDIU	SP, SP, 16
LH	R25, 16(SP)
;Sim800.c,866 :: 		goto next; //if cell matches allow to CANCEL
J	___ReadMSG_next
NOP	
;Sim800.c,867 :: 		}else{
L_ReadMSG145:
...
NOP	
LH	R25, 16(SP)
;Sim800.c,870 :: 		return 15;
ORI	R2, R0, 15
J	L_end_ReadMSG
NOP	
;Sim800.c,871 :: 		}else{
L_ReadMSG147:
;Sim800.c,872 :: 		SendSMS(13,0);
SH	R25, 16(SP)
MOVZ	R26, R0, R0
ORI	R25, R0, 13
JAL	_SendSMS+0
NOP	
LH	R25, 16(SP)
;Sim800.c,873 :: 		return 13;
ORI	R2, R0, 13
J	L_end_ReadMSG
NOP	
;Sim800.c,876 :: 		}else if(res == 19){//HUE
L_ReadMSG140:
LH	R3, 20(SP)
ORI	R2, R0, 19
...
NOP	
L__ReadMSG346:
;Sim800.c,877 :: 		goto next;
J	___ReadMSG_next
NOP	
;Sim800.c,878 :: 		}else
L_ReadMSG150:
;Sim800.c,879 :: 		SendSMS(12,0);
SH	R25, 16(SP)
MOVZ	R26, R0, R0
ORI	R25, R0, 12
JAL	_SendSMS+0
...
;Sim800.c,880 :: 		next:
___ReadMSG_next:
;Sim800.c,881 :: 		TestRecievedSMS(res);
SH	R25, 16(SP)
LH	R25, 20(SP)
...
; end of _ReadMSG
_TestRecievedSMS:
;Sim800.c,889 :: 		void TestRecievedSMS(int res){
ADDIU	SP, SP, -80
SW	RA, 0(SP)
;Sim800.c,894 :: 		sprintf(B,"%d",res);
SW	R25, 4(SP)
SW	R26, 8(SP)
ADDIU	R3, SP, 14
SH	R25, 12(SP)
...
ADDIU	SP, SP, -12
SW	R2, 8(SP)
;Sim800.c,896 :: 		" *Str check result:= %s\r\n"
LUI	R2, hi_addr(?lstr_73_Sim800+0)
ORI	R2, R2, lo_addr(?lstr_73_Sim800+0)
SW	R2, 4(SP)
;Sim800.c,895 :: 		PrintOut(PrintHandler, "\r\n"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,897 :: 		,B);
...
ADDIU	SP, SP, 12
LH	R25, 12(SP)
;Sim800.c,900 :: 		switch(res){
J	L_TestRecievedSMS152
NOP	
;Sim800.c,901 :: 		case 6:
L_TestRecievedSMS154:
;Sim800.c,902 :: 		SendSMS(7,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 7
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,907 :: 		case 8: //G
L_TestRecievedSMS156:
;Sim800.c,908 :: 		SendSMS(12,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 12
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,910 :: 		case 9: //B
L_TestRecievedSMS157:
;Sim800.c,911 :: 		SendSMS(12,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 12
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,916 :: 		case 13:
L_TestRecievedSMS159:
;Sim800.c,917 :: 		SendSMS(8,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 8
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,919 :: 		case 14:
L_TestRecievedSMS160:
;Sim800.c,920 :: 		SendSMS(6,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 6
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,922 :: 		case 15: //write,
L_TestRecievedSMS161:
;Sim800.c,923 :: 		SendSMS(12,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 12
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,925 :: 		case 16:
L_TestRecievedSMS162:
;Sim800.c,926 :: 		GetValuesFromFlash();
JAL	_GetValuesFromFlash+0
NOP	
;Sim800.c,927 :: 		NVMErasePage(FLASH_Settings_PAddr);
LW	R25, Offset(_FLASH_Settings_PAddr+0)(GP)
JAL	_NVMErasePage+0
NOP	
;Sim800.c,928 :: 		if(string[5] != NULL){
MOVZ	R3, R0, R0
LUI	R2, hi_addr(_string+320)
ORI	R2, R2, lo_addr(_string+320)
...
;Sim800.c,929 :: 		strcpy(B,string[5]);
ADDIU	R2, SP, 14
LUI	R26, hi_addr(_string+320)
ORI	R26, R26, lo_addr(_string+320)
MOVZ	R25, R2, R0
JAL	_strcpy+0
NOP	
;Sim800.c,930 :: 		Threshold.time_to_log = atoi(B);
ADDIU	R2, SP, 14
MOVZ	R25, R2, R0
JAL	_atoi+0
NOP	
SH	R2, Offset(_Threshold+8)(GP)
;Sim800.c,931 :: 		Threshold.time_to_log -= 1;
ADDIU	R2, R2, -1
SH	R2, Offset(_Threshold+8)(GP)
;Sim800.c,932 :: 		}
L_TestRecievedSMS163:
;Sim800.c,933 :: 		WriteToFlashTemp();
JAL	_WriteToFlashTemp+0
NOP	
;Sim800.c,934 :: 		t =  Write_Thresholds(0);
MOVZ	R25, R0, R0
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,943 :: 		case 17:
L_TestRecievedSMS164:
;Sim800.c,944 :: 		SimVars.init_inc = 5;  //Test started
ORI	R2, R0, 5
SB	R2, Offset(_SimVars+1)(GP)
;Sim800.c,945 :: 		T0_SP.sec = T0_SP.min = T0_SP.hr = 0;
SH	R0, Offset(_T0_SP+6)(GP)
SH	R0, Offset(_T0_SP+4)(GP)
SH	R0, Offset(_T0_SP+2)(GP)
;Sim800.c,946 :: 		SendSMS(9,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 9
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,948 :: 		case 18:
L_TestRecievedSMS165:
;Sim800.c,949 :: 		SimVars.init_inc = 3;  //Test Stopped
ORI	R2, R0, 3
SB	R2, Offset(_SimVars+1)(GP)
;Sim800.c,950 :: 		SendSMS(10,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 10
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,952 :: 		case 19:
L_TestRecievedSMS166:
;Sim800.c,953 :: 		SendSMS(16,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 16
JAL	_SendSMS+0
NOP	
...
J	L_TestRecievedSMS153
NOP	
;Sim800.c,955 :: 		case 20:
L_TestRecievedSMS167:
;Sim800.c,956 :: 		SendSMS(12,0);
MOVZ	R26, R0, R0
ORI	R25, R0, 12
JAL	_SendSMS+0
NOP	
...
_RemoveSMSText:
;Sim800.c,968 :: 		int RemoveSMSText(int sms_cnt){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Sim800.c,971 :: 		sprintf(sms,"%d",sms_cnt);
SH	R25, 4(SP)
ADDIU	SP, SP, -12
SH	R25, 8(SP)
...
;Sim800.c,976 :: 		do{
L_RemoveSMSText169:
;Sim800.c,977 :: 		sprintf(sms,"%d",sms_cnt);
SH	R25, 4(SP)
ADDIU	SP, SP, -12
SH	R25, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,978 :: 		UART2_Write_Text("AT+CMGD=");
ADDIU	R23, SP, 6
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,979 :: 		UART2_Write_Text(sms);
LUI	R25, hi_addr(_sms+0)
ORI	R25, R25, lo_addr(_sms+0)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,980 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,981 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,984 :: 		WaitForResponse(1);
ORI	R25, R0, 1
JAL	_WaitForResponse+0
NOP	
LH	R25, 4(SP)
;Sim800.c,985 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_RemoveSMSText172:
ADDIU	R24, R24, -1
...
NOP	
;Sim800.c,986 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,987 :: 		sms_cnt--;
ADDIU	R2, R25, -1
SEH	R25, R2
;Sim800.c,988 :: 		}while(sms_cnt > 0);
SEH	R2, R2
SLTI	R2, R2, 1
...
;Sim800.c,997 :: 		int Test_Update_ThingSpeak(){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Sim800.c,999 :: 		TCS3472_getRawData(RawData);
SW	R25, 4(SP)
LUI	R25, hi_addr(_RawData+0)
ORI	R25, R25, lo_addr(_RawData+0)
JAL	_TCS3472_getRawData+0
NOP	
;Sim800.c,1000 :: 		SendData(RawData);
LUI	R25, hi_addr(_RawData+0)
ORI	R25, R25, lo_addr(_RawData+0)
JAL	_SendData+0
NOP	
;Sim800.c,1001 :: 		return 2;
ORI	R2, R0, 2
;Sim800.c,1002 :: 		}
;Sim800.c,1001 :: 		return 2;
;Sim800.c,1002 :: 		}
...
_SendData:
;Sim800.c,1007 :: 		void SendData(unsigned int* rgbc){
ADDIU	SP, SP, -436
SW	RA, 0(SP)
;Sim800.c,1013 :: 		sprintf(txtC,"%u",rgbc[0]);
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
LHU	R2, 0(R25)
...
ADDIU	SP, SP, 12
LW	R25, 16(SP)
;Sim800.c,1014 :: 		sprintf(txtR,"%u",rgbc[1]);
ADDIU	R2, R25, 2
LHU	R2, 0(R2)
SW	R25, 16(SP)
ADDIU	SP, SP, -12
...
ADDIU	SP, SP, 12
LW	R25, 16(SP)
;Sim800.c,1015 :: 		sprintf(txtG,"%u",rgbc[2]);
ADDIU	R2, R25, 4
LHU	R2, 0(R2)
SW	R25, 16(SP)
ADDIU	SP, SP, -12
...
ADDIU	SP, SP, 12
LW	R25, 16(SP)
;Sim800.c,1016 :: 		sprintf(txtB,"%u",rgbc[3]);
ADDIU	R2, R25, 6
LHU	R2, 0(R2)
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Sim800.c,1019 :: 		UART2_Write_Text("AT+CIPSHUT");
ADDIU	R23, SP, 220
ADDIU	R22, R23, 11
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1020 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1021 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1022 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1023 :: 		Delay_ms(500);
LUI	R24, 203
ORI	R24, R24, 29524
L_SendData174:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1026 :: 		UART1_Write_Text("Prepare str for thingspeak");
ADDIU	R23, SP, 231
ADDIU	R22, R23, 27
...
JAL	_UART1_Write_Text+0
NOP	
;Sim800.c,1027 :: 		UART1_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART1_Write+0
NOP	
;Sim800.c,1028 :: 		UART1_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART1_Write+0
NOP	
;Sim800.c,1031 :: 		strncpy(str,str_api,46);//strlen(str_api));
ADDIU	R2, SP, 20
ORI	R27, R0, 46
...
JAL	_strncpy+0
NOP	
;Sim800.c,1032 :: 		strncat(str,SF.WriteAPIKey,strlen(SF.WriteAPIKey));
LUI	R25, hi_addr(_SF+58)
ORI	R25, R25, lo_addr(_SF+58)
JAL	_strlen+0
NOP	
...
JAL	_strncat+0
NOP	
;Sim800.c,1033 :: 		strncat(str,field1,strlen(field1));
...
JAL	_strncat+0
NOP	
;Sim800.c,1034 :: 		strncat(str,txtC,strlen(txtC));
...
JAL	_strncat+0
NOP	
;Sim800.c,1035 :: 		strncat(str,field2,strlen(field2));
...
JAL	_strncat+0
NOP	
;Sim800.c,1036 :: 		strncat(str,txtR,strlen(txtR));
...
JAL	_strncat+0
NOP	
;Sim800.c,1037 :: 		strncat(str,field3,strlen(field3));
...
JAL	_strncat+0
NOP	
;Sim800.c,1038 :: 		strncat(str,txtG,strlen(txtG));
...
JAL	_strncat+0
NOP	
;Sim800.c,1039 :: 		strncat(str,field4,strlen(field4));
...
JAL	_strncat+0
NOP	
;Sim800.c,1040 :: 		strncat(str,txtB,strlen(txtB));
...
JAL	_strncat+0
NOP	
;Sim800.c,1054 :: 		UART1_Write_Text(str);
ADDIU	R2, SP, 20
MOVZ	R25, R2, R0
JAL	_UART1_Write_Text+0
NOP	
;Sim800.c,1055 :: 		UART1_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART1_Write+0
NOP	
;Sim800.c,1056 :: 		UART1_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART1_Write+0
NOP	
;Sim800.c,1059 :: 		UART2_Write_Text("AT+CPIN?");
ADDIU	R23, SP, 258
ADDIU	R22, R23, 9
...
NOP	
NOP	
;Sim800.c,1064 :: 		UART2_Write_Text("AT+CREG?");
ADDIU	R23, SP, 267
ADDIU	R22, R23, 9
...
NOP	
NOP	
;Sim800.c,1069 :: 		UART2_Write_Text("AT+CGATT?");
ADDIU	R23, SP, 276
ADDIU	R22, R23, 10
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1070 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1071 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1072 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1073 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData180:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1074 :: 		UART2_Write_Text("AT+CIPSHUT");
ADDIU	R23, SP, 286
ADDIU	R22, R23, 11
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1075 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1076 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1077 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1078 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData182:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1079 :: 		UART2_Write_Text("AT+CIPSTATUS");
ADDIU	R23, SP, 297
ADDIU	R22, R23, 13
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1080 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1081 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1082 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1083 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData184:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1084 :: 		UART2_Write_Text("AT+CIPMUX=0");
ADDIU	R23, SP, 310
ADDIU	R22, R23, 12
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1085 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1086 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1087 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
...
NOP	
NOP	
;Sim800.c,1089 :: 		UART2_Write_Text("AT+CSTT=");//\"data.uk\",\"user\",\"one2one\"");
ADDIU	R23, SP, 322
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1090 :: 		UART2_Write_Text(SF.APN);
LUI	R25, hi_addr(_SF+98)
ORI	R25, R25, lo_addr(_SF+98)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1091 :: 		UART2_Write_Text(",\"user\",");
ADDIU	R23, SP, 331
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1092 :: 		UART2_Write_Text(SF.PWD);
LUI	R25, hi_addr(_SF+118)
ORI	R25, R25, lo_addr(_SF+118)
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1093 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1094 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1095 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1096 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData188:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1097 :: 		UART2_Write_Text("AT+CIICR");
ADDIU	R23, SP, 340
ADDIU	R22, R23, 9
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1098 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1099 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1100 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1101 :: 		UART2_Write_Text("AT+CIFSR");
ADDIU	R23, SP, 349
ADDIU	R22, R23, 9
...
NOP	
;Sim800.c,1105 :: 		UART2_Write_Text("AT+CIPSPRT=1");
ADDIU	R23, SP, 358
ADDIU	R22, R23, 13
...
NOP	
NOP	
;Sim800.c,1110 :: 		UART2_Write_Text("AT+CIPSTART=\"TCP\",\"api.thingspeak.com\",80");
ADDIU	R23, SP, 371
ADDIU	R22, R23, 42
...
NOP	
;Sim800.c,1115 :: 		UART2_Write_Text("AT+CIPSEND");
ADDIU	R23, SP, 413
ADDIU	R22, R23, 11
...
NOP	
;Sim800.c,1119 :: 		UART2_Write_Text(str);
ADDIU	R2, SP, 20
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1120 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1121 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
...
JAL	_UART2_Write+0
NOP	
;Sim800.c,1124 :: 		UART2_Write(0x1A);
ORI	R25, R0, 26
JAL	_UART2_Write+0
NOP	
;Sim800.c,1125 :: 		TestForOK(1);
ORI	R25, R0, 1
JAL	_TestForOK+0
NOP	
;Sim800.c,1126 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData198:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;Sim800.c,1127 :: 		UART2_Write_Text("AT+CIPSHUT");
ADDIU	R23, SP, 424
ADDIU	R22, R23, 11
...
JAL	_UART2_Write_Text+0
NOP	
;Sim800.c,1128 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Sim800.c,1129 :: 		UART2_Write(0x0A);
ORI	R25, R0, 10
JAL	_UART2_Write+0
NOP	
;Sim800.c,1130 :: 		TestForOK(0);
MOVZ	R25, R0, R0
JAL	_TestForOK+0
NOP	
;Sim800.c,1131 :: 		Delay_ms(50);
LUI	R24, 20
ORI	R24, R24, 22612
L_SendData200:
ADDIU	R24, R24, -1
...
; end of _SendData
_TestForOK:
;Sim800.c,1139 :: 		void TestForOK(char c){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Sim800.c,1141 :: 		WaitForResponse(1);
SW	R26, 4(SP)
SB	R25, 8(SP)
ORI	R25, R0, 1
JAL	_WaitForResponse+0
...
NOP	
;Sim800.c,1143 :: 		RingToTempBuf();
JAL	_RingToTempBuf+0
NOP	
;Sim800.c,1147 :: 		,SimTestTxt);
LUI	R2, hi_addr(_SimTestTxt+0)
ORI	R2, R2, lo_addr(_SimTestTxt+0)
SB	R25, 8(SP)
ADDIU	SP, SP, -12
...
SW	R2, 4(SP)
;Sim800.c,1145 :: 		PrintOut(PrintHandler, "Test for OK:"
LUI	R2, hi_addr(_PrintHandler+0)
ORI	R2, R2, lo_addr(_PrintHandler+0)
SW	R2, 0(SP)
;Sim800.c,1147 :: 		,SimTestTxt);
...
ADDIU	SP, SP, 12
LBU	R25, 8(SP)
;Sim800.c,1149 :: 		lastMillis = TMR0.millis;
; lastMillis start address is: 16 (R4)
LW	R4, Offset(_TMR0+0)(GP)
;Sim800.c,1150 :: 		if(c == 0)
ANDI	R2, R25, 255
...
MOVZ	R5, R4, R0
;Sim800.c,1151 :: 		while(!strstr(SimTestTxt, "OK")){
L_TestForOK205:
; lastMillis start address is: 20 (R5)
; lastMillis start address is: 20 (R5)
; lastMillis end address is: 20 (R5)
...
L__TestForOK382:
; lastMillis end address is: 20 (R5)
;Sim800.c,1152 :: 		newMillis = TMR0.millis - lastMillis;
; lastMillis start address is: 20 (R5)
LW	R2, Offset(_TMR0+0)(GP)
SUBU	R2, R2, R5
;Sim800.c,1153 :: 		if(newMillis > 5000)
SLTIU	R2, R2, 5001
...
; lastMillis end address is: 16 (R4)
MOVZ	R5, R4, R0
;Sim800.c,1157 :: 		while(!strstr(SimTestTxt, "CONNECT")){
L_TestForOK210:
; lastMillis start address is: 20 (R5)
; lastMillis start address is: 20 (R5)
; lastMillis end address is: 20 (R5)
...
L__TestForOK385:
; lastMillis end address is: 20 (R5)
;Sim800.c,1158 :: 		newMillis = TMR0.millis - lastMillis;
; lastMillis start address is: 20 (R5)
LW	R2, Offset(_TMR0+0)(GP)
SUBU	R2, R2, R5
;Sim800.c,1159 :: 		if(newMillis > 5000)
SLTIU	R2, R2, 5001
