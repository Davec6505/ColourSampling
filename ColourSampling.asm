_main:
;ColourSampling.c,29 :: 		void main() {
ADDIU	SP, SP, -48
;ColourSampling.c,37 :: 		Update_Test = Test_Update_ThingSpeak;
LUI	R2, hi_addr(_Test_Update_ThingSpeak+0)
ORI	R2, R2, lo_addr(_Test_Update_ThingSpeak+0)
SW	R2, Offset(_Update_Test+0)(GP)
;ColourSampling.c,39 :: 		ConfigPic();
JAL	_ConfigPic+0
NOP	
;ColourSampling.c,41 :: 		Delay_ms(500);
LUI	R24, 203
ORI	R24, R24, 29524
L_main0:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;ColourSampling.c,43 :: 		it = TCS3472_INTEGRATIONTIME_24MS;//TCS3472_INTEGRATIONTIME_2_4MS;
ORI	R2, R0, 246
SB	R2, Offset(_it+0)(GP)
;ColourSampling.c,44 :: 		G  = TCS3472_GAIN_1X;
SB	R0, Offset(_G+0)(GP)
;ColourSampling.c,45 :: 		device_Id = TCS3472_1_5;          //TCS347_11_15;
ORI	R2, R0, 68
SB	R2, Offset(_device_Id+0)(GP)
;ColourSampling.c,47 :: 		i = TCS3472_Init(it,G,device_Id);
ORI	R27, R0, 68
MOVZ	R26, R0, R0
ORI	R25, R0, 246
JAL	_TCS3472_Init+0
NOP	
;ColourSampling.c,48 :: 		sprintf(txtR,"%2x",i);
ADDIU	R3, SP, 22
ADDIU	SP, SP, -12
SB	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;ColourSampling.c,49 :: 		strcat(writebuff,txtR);
ADDIU	R2, SP, 22
MOVZ	R26, R2, R0
...
JAL	_strcat+0
NOP	
;ColourSampling.c,50 :: 		while(!HID_Write(&writebuff,64));
L_main2:
ORI	R26, R0, 64
LUI	R25, hi_addr(_writebuff+0)
ORI	R25, R25, lo_addr(_writebuff+0)
...
NOP	
L_main3:
;ColourSampling.c,55 :: 		UART1_Write_Text("Start");
ORI	R30, R0, 83
SB	R30, 40(SP)
ORI	R30, R0, 116
SB	R30, 41(SP)
...
NOP	
;ColourSampling.c,56 :: 		UART1_Write(13);
ORI	R25, R0, 13
JAL	_UART1_Write+0
NOP	
;ColourSampling.c,57 :: 		UART1_Write(10);
ORI	R25, R0, 10
JAL	_UART1_Write+0
NOP	
;ColourSampling.c,59 :: 		T0_SP.sec = 0;
SH	R0, Offset(_T0_SP+2)(GP)
;ColourSampling.c,60 :: 		T0_SP.min = 0;
SH	R0, Offset(_T0_SP+4)(GP)
;ColourSampling.c,61 :: 		T0_SP.hr  = 0;
SH	R0, Offset(_T0_SP+6)(GP)
;ColourSampling.c,68 :: 		strcpy(cel_num,GetValuesFromFlash());
...
JAL	_strcpy+0
NOP	
;ColourSampling.c,69 :: 		str_num = strncmp(cel_num,sub_txt,4);
ADDIU	R2, SP, 2
ORI	R27, R0, 4
...
SEH	R4, R2
;ColourSampling.c,71 :: 		sprintf(txtR,"%u",str_num);
ADDIU	R3, SP, 22
SH	R4, 0(SP)
ADDIU	SP, SP, -12
SH	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;ColourSampling.c,75 :: 		,cel_num,txtR);
ADDIU	R3, SP, 22
ADDIU	R2, SP, 2
ADDIU	SP, SP, -16
SW	R3, 12(SP)
SW	R2, 8(SP)
;ColourSampling.c,74 :: 		" *Result of cmp: %s\r\n"
LUI	R2, hi_addr(?lstr_4_ColourSampling+0)
ORI	R2, R2, lo_addr(?lstr_4_ColourSampling+0)
SW	R2, 4(SP)
;ColourSampling.c,72 :: 		PrintOut(PrintHandler, "\r\n"
...
ADDIU	SP, SP, 16
LHU	R4, 0(SP)
;ColourSampling.c,77 :: 		if(str_num != 0){
ANDI	R2, R4, 65535
...
MOVZ	R2, R0, R0
;ColourSampling.c,86 :: 		}else{
; cell_ok end address is: 8 (R2)
J	L_main7
NOP	
L_main4:
;ColourSampling.c,87 :: 		WaitForResponse(3);
ORI	R25, R0, 3
...
;ColourSampling.c,90 :: 		}
L_main7:
;ColourSampling.c,95 :: 		if(cell_ok == 1){ //only if primary cell num has been saved
; cell_ok start address is: 8 (R2)
ANDI	R3, R2, 65535
; cell_ok end address is: 8 (R2)
ORI	R2, R0, 1
...
LBU	R2, Offset(_T0_SP+14)(GP)
BNE	R2, R0, L__main31
NOP	
J	L_main15
NOP	
L__main31:
;ColourSampling.c,117 :: 		T0_SP.one_per_sec = 0;
SB	R0, Offset(_T0_SP+14)(GP)
;ColourSampling.c,118 :: 		res = Update_Test(T0_SP.sec,T0_SP.min,T0_SP.hr);
...
NOP	
L__main32:
;ColourSampling.c,120 :: 		T0_SP.sec = 0;
SH	R0, Offset(_T0_SP+2)(GP)
;ColourSampling.c,121 :: 		T0_SP.min = 0;
SH	R0, Offset(_T0_SP+4)(GP)
;ColourSampling.c,122 :: 		T0_SP.hr = 0;
SH	R0, Offset(_T0_SP+6)(GP)
;ColourSampling.c,123 :: 		}
L_main16:
;ColourSampling.c,124 :: 		}
L_main15:
;ColourSampling.c,125 :: 		}
L_main14:
;ColourSampling.c,128 :: 		res = TestRingPointers();
JAL	_TestRingPointers+0
NOP	
; res start address is: 16 (R4)
SEH	R4, R2
;ColourSampling.c,129 :: 		if(res > 1){
SEH	R2, R2
SLTI	R2, R2, 2
BEQ	R2, R0, L__main33
NOP	
...
NOP	
L__main33:
;ColourSampling.c,131 :: 		sprintf(txtR,"%d",res);
ADDIU	R3, SP, 22
ADDIU	SP, SP, -12
SH	R4, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;ColourSampling.c,138 :: 		,txtT,txtH,txtR);
ADDIU	R4, SP, 22
ADDIU	R3, SP, 28
ADDIU	R2, SP, 34
ADDIU	SP, SP, -20
...
SW	R3, 12(SP)
SW	R2, 8(SP)
;ColourSampling.c,137 :: 		" *Diff in pointers:= %s\r\n"
...
NOP	
ADDIU	SP, SP, 20
;ColourSampling.c,141 :: 		GetSMSText();
JAL	_GetSMSText+0
NOP	
;ColourSampling.c,142 :: 		}
L_main17:
;ColourSampling.c,145 :: 		if(!RG9_bit)
_LX	
...
NOP	
L__main34:
;ColourSampling.c,146 :: 		NVMErasePage(FLASH_Settings_PAddr);//SendSMS(100);
LW	R25, Offset(_FLASH_Settings_PAddr+0)(GP)
JAL	_NVMErasePage+0
NOP	
L_main18:
;ColourSampling.c,147 :: 		if(!RE4_bit){
_LX	
...
NOP	
L__main35:
;ColourSampling.c,148 :: 		GetValuesFromFlash();
JAL	_GetValuesFromFlash+0
NOP	
;ColourSampling.c,149 :: 		TCS3472_getRawData(RawData);
LUI	R25, hi_addr(_RawData+0)
ORI	R25, R25, lo_addr(_RawData+0)
JAL	_TCS3472_getRawData+0
NOP	
;ColourSampling.c,150 :: 		SendData(RawData);
LUI	R25, hi_addr(_RawData+0)
ORI	R25, R25, lo_addr(_RawData+0)
JAL	_SendData+0
NOP	
