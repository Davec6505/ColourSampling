...
JAL	_ConfigPic+0
NOP	
;ColourSampling.c,24 :: 		Delay_ms(5000);
LUI	R24, 2034
ORI	R24, R24, 33108
L_main0:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;ColourSampling.c,25 :: 		it = TCS3472_INTEGRATIONTIME_24MS;//TCS3472_INTEGRATIONTIME_2_4MS;
ORI	R2, R0, 246
...
JAL	_TCS3472_Init+0
NOP	
;ColourSampling.c,30 :: 		sprintf(txtR,"%2x",i);
ADDIU	R3, SP, 0
ADDIU	SP, SP, -12
SB	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;ColourSampling.c,31 :: 		strcat(writebuff,txtR);
ADDIU	R2, SP, 0
MOVZ	R26, R2, R0
...
JAL	_strcat+0
NOP	
;ColourSampling.c,32 :: 		while(!HID_Write(&writebuff,64));
L_main2:
ORI	R26, R0, 64
LUI	R25, hi_addr(_writebuff+0)
ORI	R25, R25, lo_addr(_writebuff+0)
