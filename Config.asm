_ConfigPic:
;Config.c,5 :: 		void ConfigPic(){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Config.c,6 :: 		CHECON = 30;
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
SW	R28, 16(SP)
...
;Config.c,7 :: 		AD1PCFG = 0xFFFFFFFF;
LUI	R2, 65535
ORI	R2, R2, 65535
SW	R2, Offset(AD1PCFG+0)(GP)
;Config.c,8 :: 		JTAGEN_bit = 0;
_LX	
INS	R2, R0, BitPos(JTAGEN_bit+0), 1
_SX	
;Config.c,10 :: 		TRISA = 0X0200;
ORI	R2, R0, 512
SW	R2, Offset(TRISA+0)(GP)
;Config.c,11 :: 		TRISB = 0X0000;
SW	R0, Offset(TRISB+0)(GP)
;Config.c,12 :: 		TRISC = 0X0000;
SW	R0, Offset(TRISC+0)(GP)
;Config.c,13 :: 		TRISD = 0X0000;
SW	R0, Offset(TRISD+0)(GP)
;Config.c,14 :: 		TRISE = 0X0010;
ORI	R2, R0, 16
SW	R2, Offset(TRISE+0)(GP)
;Config.c,15 :: 		TRISF = 0X0000;
